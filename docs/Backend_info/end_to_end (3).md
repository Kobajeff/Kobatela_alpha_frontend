...
| --- | --- | --- | --- |
| **Sender** | `sender` | Can create escrows, activate, fund/deposit, mark delivered, approve/reject, check deadlines, manage milestones + fraud expectations, issue external proof tokens, request advisor review, execute sender payouts, and list/view their escrows; can submit or decide proofs depending on workflow.【F:app/routers/escrow.py†L79-L285】【F:app/routers/sender_escrow_milestones.py†L15-L49】【F:app/routers/sender_fraud_config.py†L11-L99】【F:app/routers/external_proof_tokens.py†L17-L129】【F:app/routers/sender_payments.py†L9-L35】【F:app/routers/proofs.py†L36-L178】【F:app/routers/advisors.py†L184-L228】 | Primary funder/decision-maker. |
...
- **Fraud Config (sender)** → `GET/PATCH /sender/escrows/{id}/fraud-config`, `GET/PATCH /sender/escrows/{id}/milestones/{milestone_idx}/fraud-config`【F:app/routers/sender_fraud_config.py†L11-L99】
...
| --- | --- | --- |
| **MVP (implementable now)** | Sender escrow creation/activation/funding, milestone + fraud config management, proof review/decisions, and sender payout execution; provider inbox + proof upload; support/admin proof review queue + payout execution; external proof tokens + external beneficiary upload summary. | Backed by `/escrows`, `/sender/escrows/*`, `/sender/escrows/*/fraud-config`, `/files/proofs`, `/proofs`, `/sender/payments/*/execute`, `/admin/proofs/review-queue`, `/payments/execute`, `/admin/payments`, `/sender/external-proof-tokens`, and `/external/*` endpoints.【F:app/routers/escrow.py†L33-L285】【F:app/routers/sender_escrow_milestones.py†L15-L49】【F:app/routers/sender_fraud_config.py†L11-L99】【F:app/routers/uploads.py†L73-L158】【F:app/routers/proofs.py†L36-L178】【F:app/routers/sender_payments.py†L12-L35】【F:app/routers/admin_tools.py†L22-L83】【F:app/routers/payments.py†L20-L89】【F:app/routers/external_proof_tokens.py†L32-L161】【F:app/routers/external_proofs.py†L110-L483】 |
...
| Fraud Config | `GET/PATCH /sender/escrows/{id}/fraud-config`, `GET/PATCH /sender/escrows/{id}/milestones/{milestone_idx}/fraud-config` | 【F:app/routers/sender_fraud_config.py†L11-L99】 |
| Provider Inbox | `GET /provider/inbox/escrows` | 【F:app/routers/provider_inbox.py†L10-L35】 |
