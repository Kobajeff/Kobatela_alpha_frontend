...
- `beneficiary_profile` (BeneficiaryProfilePublicRead | BeneficiaryProfileAdminRead, nullable)  
- `amount_total` (string decimal)  
- `currency` (string)  
...
- `escrow` (EscrowRead)  
- `milestones` (array of MilestoneRead)  
...
### 4.7 FE3 Fraud Config + Runtime Mode
| Method | Path | Summary | Scope | Request → Response | Notes | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
...
### 4.8 Admin Transactions (read-only Ops)
| Method | Path | Summary | Scope | Request → Response | Notes | Evidence |
| --- | --- | --- | --- | --- | --- | --- |
