...
Checklist:
1) Confirm escrow status via `GET /escrows/{id}` (support/admin allowed).【F:app/routers/escrow.py†L216-L230】
...
Checklist:
1) Pull proof details or review queue using `/admin/proofs/review-queue` to inspect review_mode and AI risk indicators.【F:app/routers/admin_tools.py†L39-L107】
