...
POST | /external/files/proofs | `upload_external_proof_file` | Public (token) | — | multipart/form-data + token via `Authorization: Bearer <token>` (official) or `X-External-Token` header | `ExternalProofUploadResponse` | 201 | UNSUPPORTED_FILE_TYPE, FILE_TOO_LARGE, FILE_UPLOAD_FAILED | 【F:app/routers/external_proofs.py†L138-L194】【F:app/security/external_tokens.py†L1-L25】【F:app/schemas/external_proofs.py†L34-L55】
POST | /external/proofs/submit | `submit_external_proof` | Public (token) | — | `ExternalProofSubmit` (escrow_id/milestone_idx optional; token fills when omitted) + token via `Authorization: Bearer <token>` (official) or `X-External-Token` header | `ExternalProofSubmitResponse` | 201 | TOKEN_ESCROW_MISMATCH, TOKEN_MILESTONE_MISMATCH, FILE_METADATA_REQUIRED, TOKEN_FILE_ALREADY_SET | 【F:app/routers/external_proofs.py†L196-L315】【F:app/security/external_tokens.py†L1-L25】【F:app/schemas/external_proofs.py†L57-L99】
GET | /external/escrows/summary | `get_external_escrow_summary` | Public (token) | — | Token via `Authorization: Bearer <token>` (official) or `X-External-Token` header | `ExternalEscrowSummary` | 200 | TOKEN_ESCROW_MISMATCH | 【F:app/routers/external_proofs.py†L318-L352】【F:app/security/external_tokens.py†L1-L25】【F:app/schemas/external_proofs.py†L102-L131】
GET | /external/escrows/{escrow_id} | `get_external_escrow_summary_by_path` | Public (token) | — | Backward-compatible path param + token via `Authorization: Bearer <token>` (official) or `X-External-Token` header | `ExternalEscrowSummary` | 200 | TOKEN_ESCROW_MISMATCH | 【F:app/routers/external_proofs.py†L355-L389】【F:app/security/external_tokens.py†L1-L25】【F:app/schemas/external_proofs.py†L102-L131】
GET | /external/proofs/{proof_id}/status | `get_external_proof_status` | Public (token) | — | Token via `Authorization: Bearer <token>` (official) or `X-External-Token` header | `ExternalProofStatusResponse` | 200 | PROOF_NOT_FOUND, TOKEN_ESCROW_MISMATCH | 【F:app/routers/external_proofs.py†L392-L430】【F:app/security/external_tokens.py†L1-L25】【F:app/schemas/external_proofs.py†L101-L138】
